...
public class NoteReminderNotification {
    ...
    public static final String CHANNEL_ID = "primary channel_id";
    ...
    public static void createNotificationChannel(Context context){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            channel.setDescription("Notes notification");
...
//        backUpServiceIntent.putExtra(NoteBackupService.EXTRA_COURSE_ID, NoteBackup.ALL_COURSES);
        ...
        Intent backUpServiceIntent = new Intent(context, NoteBackUpReceiverNotification.class);
        backUpServiceIntent.putExtra(NoteBackupService.EXTRA_COURSE_ID, NoteBackup.ALL_COURSES);

        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, 0,  backUpServiceIntent,
