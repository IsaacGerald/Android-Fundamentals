...
public class NoteReminderReceiver extends BroadcastReceiver {
    public static final String EXTRA_NOTE_TITLE = "com.jwhh.jim.notekeeper.extras.EXTRA_NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.jwhh.jim.notekeeper.extras.EXTRA_NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "com.jwhh.jim.notekeeper.extras.EXTRA_NOTE_ID";
