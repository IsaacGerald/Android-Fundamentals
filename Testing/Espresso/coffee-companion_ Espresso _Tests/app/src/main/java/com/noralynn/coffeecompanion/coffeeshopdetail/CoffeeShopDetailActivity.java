...
public class CoffeeShopDetailActivity extends AppCompatActivity implements CoffeeShopDetailView {
    ...
    private void initializeViews() {
        ...
        titleTextView = (TextView) findViewById(R.id.text_title_coffee);
...
//        }
    ...
    @Override
    public void sendWebsiteIntent(@NonNull CoffeeShopDetailModel coffeeShopDetailModel) {
        CoffeeShop coffeeShop = coffeeShopDetailModel.getCoffeeShop();
        if (null == coffeeShop){
            return;
        }

        String websiteUrl = coffeeShop.getWebsiteUrl();
