...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch) {
            case COURSES:
                //vnd.android.cursor.dir/vnd.com.jwhh.jim.provider.courses
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
                        MIME_VENDOR_TYPE + Courses.PATH;
                break;
            case NOTES:
                //vnd.android.cursor.dir/vnd.com.jwhh.jim.provider.notes
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
                        MIME_VENDOR_TYPE + Notes.PATH;
                break;
            case NOTES_EXPANDED:
                //vnd.android.cursor.dir/vnd.com.jwhh.jim.provider.notes_expanded
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            case NOTES:
                ...
                //content://com.jww.jim.notekeeper/notes/1
