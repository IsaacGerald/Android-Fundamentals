...
public class MainActivity extends AppCompatActivity {
    ...
    private  String preferenceFileName = "com.example.android.scorekeeper";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        mPreferences = getSharedPreferences(preferenceFileName, MODE_PRIVATE);

        //Find the TextViews by ID
        mScoreText1 = findViewById(R.id.score_1);
        mScoreText2 = findViewById(R.id.score_2);

//        Restores value from SharedPreference
        mScore1 = mPreferences.getInt(SCORE_1, 0);
        mScoreText1.setText(String.valueOf(mScore1));
        mScore2 = mPreferences.getInt(SCORE_2, 0);
...
//        }
    ...
    protected void onPause() {
        ...
        editor.putInt(SCORE_1, mScore1);
        editor.putInt(SCORE_2, mScore2);
        editor.apply();
    }
